...
You can filter this component, search through it and edit it - what makes it perfect tool for being fornt end for databases and CRUD without stressing with REST. 
